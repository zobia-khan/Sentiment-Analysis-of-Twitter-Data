...
def pre_process_roman_urdu(filename):
    ...
    report(scrapped_file_path,unique_filename,'Roman Urdu')
...
def feature_extraction_roman_urdu(filename):
    ...
    scaleddata = scaler.fit_transform(data_features_w2v)
     # Loading model
    lr_roman_urdu_model = pickle.load(open('media/models/roman_urdu/lr_romanurdu.pkl','rb')) #give path of best model
...
#pre_process_roman_urdu('media/scrapped/pure romanurdu data/zobia_mehengai_2021_10001.csv')
